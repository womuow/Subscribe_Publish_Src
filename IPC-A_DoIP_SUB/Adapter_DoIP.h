...
#ifndef ADAPTER_DoIP_H
#define ADAPTER_DoIP_H
...
// private:
	...
	std::string topic2 = "ipc_services/msg/publisher";
...
extern std::string data_in2;
extern std::atomic_bool stop2;
extern UDS_ipc_req UDS_ipc_req_;
extern UDS_ipc_response UDS_ipc_response_;


extern std::map<std::string, VariableVariant > DoIP_Map;
