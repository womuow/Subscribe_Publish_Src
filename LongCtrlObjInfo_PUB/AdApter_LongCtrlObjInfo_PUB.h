...
#ifndef ADAPTER_LONGCTRLOBJINFO_PUB_H
#define ADAPTER_LONGCTRLOBJINFO_PUB_H

using namespace std::chrono_literals;
// using namespace org::eclipse::cyclonedds;
class AdApter_LongCtrlObjInfoPUB
{
public:
	AdApter_LongCtrlObjInfoPUB();
	~AdApter_LongCtrlObjInfoPUB();	void run();
	std::string json_file = "";
	// dds::sub::DataReader<LongCtrlObjInfoPUBModule::LongCtrlObjInfoPUB> topic_read_init(std::string topicName);
	// LongCtrlObjInfoPUBModule::LongCtrlObjInfoPUB topic_out;
	//std::string topicName = "rte2dds/LongCtrlObjInfoPUB";
	int domiain_id = 0;
	bool type = false;
	...
	// void update_objInfo(const LongCtrlObjInfoPUBModule::LongCtrlObjInfoPUB msg);
private:
};



#endif // ADAPTER_LONGCTRLOBJINFO_PUB_H