...
#include <thread>
#include "dds/dds.hpp"
#include "FlcRoadCover.hpp"
#include "FlcRoadCover.h"
#include <atomic>
#include <chrono>
#include <csignal>
#include <filesystem>
...
class AdApter_FlcRoadCover
{
public:
	AdApter_FlcRoadCover();
	~AdApter_FlcRoadCover();	void run();
	std::string json_file = "";
	dds::pub::DataWriter<FlcRoadCoverModule::FlcRoadCover> topic_writer_init(std::string topicName);
	FlcRoadCoverModule::FlcRoadCover topic_out;
	std::string topicName = "dds2rte/FlcRoadCover";
	int domiain_id = 0;
	bool type = false;
