...
class AdApter_EgoVehicleState
{
public:
	AdApter_EgoVehicleState();
	~AdApter_EgoVehicleState();	void run();
	std::string json_file = "";
	dds::pub::DataWriter<EgoVehicleStateModule::EgoVehicleState> topic_writer_init(std::string topicName);
	EgoVehicleStateModule::EgoVehicleState topic_out;
	std::string topicName = "dds2rte/EgoVehicleState";
	int domiain_id = 0;
	bool type = false;
