...
#define ADAPTER_Logistics_Data_H

using namespace std::chrono_literals;


class Adapter_Logistics_Data
{
public:
	Adapter_Logistics_Data();
	~Adapter_Logistics_Data();
	void run();
...
extern Logistics_data Logistics_data_;
extern Logistics_data Logistics_data_old;

extern std::map<std::string, VariableVariant > Logistics_data_Map;
