...
int config_async_sub(std::string json_file) {
    ...
    while (true) {//while (!stop.load()) {
        ...
        print_VehBusIn(VehBusIn_,VehBusIn_old,data_in);
...
void print_VehBusIn(VehBusIn& VehBusIn_,VehBusIn& VehBusIn_old,std::string data){
...
// std::cout << "VehBusIn all variable:" << std::endl;
    ...
    //     for (int i =0;i<0;i++){
    //         std::this_thread::sleep_for(std::chrono::milliseconds(10));
    //         std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
    //         std::cout << "VehBusIn_.SysSigGrp_HPCGW_CB_APP.GW_MCUS_ActualTorqueFB(float32): " << std::fixed << std::setprecision(2) << VehBusIn_.SysSigGrp_HPCGW_CB_APP.GW_MCUS_ActualTorqueFB << std::endl;
    //     }}
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_BackDoorSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_BackDoorSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_BackDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_BackDoorSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_BackDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_BackDoorSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts_VD != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts_VD){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts_VD(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts_VD) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts_VD(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_DriverDoorSts_VD) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FLDoorSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_FLDoorSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FLDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FLDoorSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FLDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FLDoorSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FRDoorSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_FRDoorSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FRDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FRDoorSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FRDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FRDoorSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FrontCoverSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_FrontCoverSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FrontCoverSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FrontCoverSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FrontCoverSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_FrontCoverSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtOpenSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_HazardSwtOpenSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtOpenSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtOpenSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtOpenSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtOpenSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_HazardSwtSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HazardSwtSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HighBeamCtrl != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_HighBeamCtrl){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HighBeamCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HighBeamCtrl) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HighBeamCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_HighBeamCtrl) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1A != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1A){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1A(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1A) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1A(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1A) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1B != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1B){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1B(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1B) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1B(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON1B) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2A != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2A){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2A(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2A) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2A(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2A) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2B != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2B){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2B(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2B) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2B(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON2B) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON3 != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON3){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON3(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON3) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON3(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_KeyPosition_ON3) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_LowBeamCtrl != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_LowBeamCtrl){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_LowBeamCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_LowBeamCtrl) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_LowBeamCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_LowBeamCtrl) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2BRelaySts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_ON2BRelaySts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2BRelaySts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2BRelaySts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2BRelaySts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2BRelaySts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2CRelaySts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_ON2CRelaySts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2CRelaySts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2CRelaySts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2CRelaySts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_ON2CRelaySts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RearFogCtrl != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_RearFogCtrl){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RearFogCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RearFogCtrl) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RearFogCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RearFogCtrl) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RLDoorSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_RLDoorSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RLDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RLDoorSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RLDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RLDoorSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RRDoorSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_RRDoorSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RRDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RRDoorSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RRDoorSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_RRDoorSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftCtrl != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_TurnLeftCtrl){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftCtrl) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftCtrl) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftSwtSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_TurnLeftSwtSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftSwtSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftSwtSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftSwtSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnLeftSwtSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightCtrl != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_TurnRightCtrl){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightCtrl) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightCtrl(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightCtrl) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightSwtSts != VehBusIn_old.SysSigGrp_HPCBCM_290.BCM_TurnRightSwtSts){
        std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightSwtSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightSwtSts) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightSwtSts(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_HPCBCM_290.BCM_TurnRightSwtSts) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_IBC_183.IBC_BrakePedalApplied != VehBusIn_old.SysSigGrp_IBC_183.IBC_BrakePedalApplied){
        std::cout << "VehBusIn_.SysSigGrp_IBC_183.IBC_BrakePedalApplied(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IBC_183.IBC_BrakePedalApplied) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_IBC_183.IBC_BrakePedalApplied(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IBC_183.IBC_BrakePedalApplied) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_IBC_227.IBC_EPB_APAACCRequest_Available != VehBusIn_old.SysSigGrp_IBC_227.IBC_EPB_APAACCRequest_Available){
        std::cout << "VehBusIn_.SysSigGrp_IBC_227.IBC_EPB_APAACCRequest_Available(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IBC_227.IBC_EPB_APAACCRequest_Available) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_IBC_227.IBC_EPB_APAACCRequest_Available(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IBC_227.IBC_EPB_APAACCRequest_Available) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_IBC_3CE.iTPMS_SystemStatus != VehBusIn_old.SysSigGrp_IBC_3CE.iTPMS_SystemStatus){
        std::cout << "VehBusIn_.SysSigGrp_IBC_3CE.iTPMS_SystemStatus(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IBC_3CE.iTPMS_SystemStatus) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_IBC_3CE.iTPMS_SystemStatus(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IBC_3CE.iTPMS_SystemStatus) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_IVI_3E3.IVI_GetRidAlarmCancelReq != VehBusIn_old.SysSigGrp_IVI_3E3.IVI_GetRidAlarmCancelReq){
        std::cout << "VehBusIn_.SysSigGrp_IVI_3E3.IVI_GetRidAlarmCancelReq(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IVI_3E3.IVI_GetRidAlarmCancelReq) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_IVI_3E3.IVI_GetRidAlarmCancelReq(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_IVI_3E3.IVI_GetRidAlarmCancelReq) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_LMC_FD.LMC_FTSC_ActiveSt != VehBusIn_old.SysSigGrp_LMC_FD.LMC_FTSC_ActiveSt){
        std::cout << "VehBusIn_.SysSigGrp_LMC_FD.LMC_FTSC_ActiveSt(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_LMC_FD.LMC_FTSC_ActiveSt) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_LMC_FD.LMC_FTSC_ActiveSt(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_LMC_FD.LMC_FTSC_ActiveSt) << std::dec  << std::endl;
    ...
    if(VehBusIn_.SysSigGrp_LMC_FD.LMC_HSPC_ActiveSt != VehBusIn_old.SysSigGrp_LMC_FD.LMC_HSPC_ActiveSt){
        std::cout << "VehBusIn_.SysSigGrp_LMC_FD.LMC_HSPC_ActiveSt(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_LMC_FD.LMC_HSPC_ActiveSt) << std::dec  << std::endl;
        for (int i =0;i<0;i++){
            std::this_thread::sleep_for(std::chrono::milliseconds(10));
            std::memcpy(&VehBusIn_, data.data(), sizeof(VehBusIn));
            std::cout << "VehBusIn_.SysSigGrp_LMC_FD.LMC_HSPC_ActiveSt(boolean): 0x" << std::hex << std::setw(2) << std::setfill('0') << static_cast<int>(VehBusIn_.SysSigGrp_LMC_FD.LMC_HSPC_ActiveSt) << std::dec  << std::endl;
