...
class AdApter_RoadPath
{
public:
	AdApter_RoadPath();
	~AdApter_RoadPath();	void run();
	std::string json_file = "";
	dds::pub::DataWriter<RoadPathModule::RoadPath> topic_writer_init(std::string topicName);
	RoadPathModule::RoadPath topic_out;
	std::string topicName = "dds2rte/RoadPath";
	int domiain_id = 0;
	bool type = false;
