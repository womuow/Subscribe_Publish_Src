...
class AdApter_TOSPUB
{
public:
	AdApter_TOSPUB();
	~AdApter_TOSPUB();	void run();
	std::string json_file = "";
	// dds::sub::DataReader<PPFPUBModule::PPFPUB> topic_read_init(std::string topicName);
	// PPFPUBModule::PPFPUB topic_out;
	//std::string topicName = "rte2dds/PPFPUB";
	int domiain_id = 0;
	bool type = false;
	...
	// void update_objInfo(const PPFPUBModule::PPFPUB msg);
