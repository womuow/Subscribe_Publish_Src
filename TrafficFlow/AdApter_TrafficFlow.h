...
class AdApter_TrafficFlow
{
public:
	AdApter_TrafficFlow();
	~AdApter_TrafficFlow();	void run();
	std::string json_file = "";
	dds::pub::DataWriter<TrafficFlowModule::TrafficFlow> topic_writer_init(std::string topicName);
	TrafficFlowModule::TrafficFlow topic_out;
	std::string topicName = "dds2rte/TrafficFlow";
	int domiain_id = 0;
	bool type = false;
