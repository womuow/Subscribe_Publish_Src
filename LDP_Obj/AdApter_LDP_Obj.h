...
class AdApter_LDP_Obj
{
public:
	AdApter_LDP_Obj();
	~AdApter_LDP_Obj();	void run();
	std::string json_file = "";
	dds::pub::DataWriter<LDP_ObjModule::LDP_Obj> topic_writer_init(std::string topicName);
	LDP_ObjModule::LDP_Obj topic_out;
	std::string topicName = "dds2rte/LDP_Obj";
	int domiain_id = 0;
	bool type = false;
