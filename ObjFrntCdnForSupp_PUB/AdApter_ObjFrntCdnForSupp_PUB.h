...
class AdApter_ObjFrntCdnForSuppPUB
{
public:
	AdApter_ObjFrntCdnForSuppPUB();
	~AdApter_ObjFrntCdnForSuppPUB();	void run();
	std::string json_file = "";
	// dds::sub::DataReader<ObjFrntCdnForSuppPUBModule::ObjFrntCdnForSuppPUB> topic_read_init(std::string topicName);
	// ObjFrntCdnForSuppPUBModule::ObjFrntCdnForSuppPUB topic_out;
	//std::string topicName = "rte2dds/ObjFrntCdnForSuppPUB";
	int domiain_id = 0;
	bool type = false;
	std::string topic = "ThrtAssemt/ObjFrntCdnForSupp";
	std::string data_in = "";
	...
	// void update_objInfo(const ObjFrntCdnForSuppPUBModule::ObjFrntCdnForSuppPUB msg);
private:
};
